        ...
        <div className="text-center max-w-4xl mx-auto 
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-14">
            ...
            <button
              ...
              hover:bg-emerald-600 hover:shadow-[0_0_25px_rgba(16,185,129,0.35)]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div className="bg-emerald-500/70 backdrop-blur-sm rounded-xl p-6
            hover:bg-emerald-500/90 hover:-translate-y-2 transition-all duration-300 border border-white/5">
